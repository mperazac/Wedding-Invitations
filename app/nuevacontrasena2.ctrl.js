...
nvaContController.$inject = ['$scope', '$location', 'rootRef', '$timeout', 'firebaseSvc', '$firebaseAuth', 'toaster'];

function nvaContController($scope, $location, rootRef, $timeout, firebaseSvc, $firebaseAuth, toaster) {
    var vm = this;
    vm.txtEmail = '';
    vm.txtPassOld = '';
    vm.txtPassNew = '';
