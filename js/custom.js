...
(function($) {
    ...
    $(document).ready(function() {
        ...
        ==================================================================================== */
        var instagramTag = 'bodamauyjesy'; // Add Instagram Tag here
        ...
        ==================================================================================== */
        if($("#countdown").length) {
            CountDownTimer('08/23/2016 9:00 AM', 'countdown');
        }
        function CountDownTimer(dt, id) {
            ...
            function showRemaining() {
                ...
                document.getElementById(id).innerHTML = days + '<span>días</span>';
                document.getElementById(id).innerHTML += hours + '<span>horas</span>';
                document.getElementById(id).innerHTML += minutes + '<span>minutos</span>';
                document.getElementById(id).innerHTML += seconds + '<span>segundos</span>';
            }
